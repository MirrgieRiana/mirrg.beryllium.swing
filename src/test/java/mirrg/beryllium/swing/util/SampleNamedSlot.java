...
import mirrg.beryllium.swing.UEvent;
...
public class SampleNamedSlot
{
	...
	public static void main(String[] args)
	{
		...
		frame.setLayout(new CardLayout());
		{
			...
			frame.add(UContainer.createBorderPanelDown(

				// 左
				UContainer.createScrollPane(UEvent.addListSelectionListener(list = new JList<NamedSlot<SampleObject>>(Stream.of(objects)
